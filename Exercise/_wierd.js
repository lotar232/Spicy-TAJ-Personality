{
    ...
    let exerciseDone = 0;
	//let //exerciseDone = 0; ///is this used? can it be deleted?

    sendVirtualAssistantMessage("%SlaveName%, you should get some water to drink at the break");
    sendVirtualAssistantMessage("If you're a proper slave, you'll put it in a bowl on the floor to drink out of like a dog");
    ...
    while (exerciseDone < 10 + getVar("ExerciseLevel")) {
        sendVirtualAssistantMessage("So far we've done " + exerciseDone + " exercises");

        if (exerciseDone % 4 == 0 && exerciseDone > 0) {
    ...
    /*
    @Variable[exercisedone]<[1] showImage("Images/Spicy/Exercise/Misc/*] @Goto(PushUps1,WidePushUps,PushUps2)
    @Variable[exercisedone]<[2] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Abs1,Abs2,Abs6)
    @Variable[exercisedone]<[3] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Squat,SquatHold,DeepSquat)
    @Variable[exercisedone]<[4] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Gif4,Gif2)
    @Variable[exercisedone]<[5] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Gif1,Gif3)
    @Variable[exercisedone]<[6] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Leg4,Leg3,Leg2,Leg1)
    @Variable[exercisedone]<[7] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Dog1,Dog2a,Dog2b)
    @Variable[exercisedone]<[8] showImage("Images/Spicy/Exercise/Misc/*] @Goto(SidePlank,Plank1)
    @Variable[exercisedone]<[9] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Gif5,Gif6)
    @Variable[exerciseDone]<[10] showImage("Images/Spicy/Exercise/Misc/*] @Goto(Abs3,Abs4,Abs5)
    ...
    */
    ...
    sendVirtualAssistantMessage("You just went through " + exerciseDone + " exercises");

    let answer = sendInput("How many of the " + exerciseDone + " exercises do you estimate to have completed on a satisfactory level?");
    ...
    } else if (exerciseDone > ExFailedBar) {
...
function Dog1() {
    //TODO: Revamp this. Right now this won't work anyway
    if (!exdog1) {
        exdog1 = true;
        ...
        sleep(40 + 15 * getVar("ExerciseLevel"));
...
function Dog2b() {
    if (!exdog2b) {
        ...
        sendVirtualAssistantMessage(" Take a short break ", 1, true);
        showImage("Images/Spicy/Exercise/Misc/*");
        playAudio("Audio/GNMSounds/CallName/CallGoodName/goodboy2.mp3");
        sleep(10);
...
function Abs2() {
    if (!exabs2) {
        ...
        playAudio("Audio/GNMSounds/SpecialSounds/Bell.mp3");
        sendVirtualAssistantMessage(" change sides..", 5, true);
        sendVirtualAssistantMessage(" Continue until you hear my bell", 1, true);
        playAudio("Audio/GNMSounds/Stroking/Metronome/40 bpm.mp3");
        sleep(25 + 5 * getVar("ExerciseLevel"));
        stopAudio();
...
function Abs3() {
    if (!exabs3) {
        ...
        sendVirtualAssistantMessage(" Continue until you hear my bell", 1, true);
        playAudio("Audio/GNMSounds/Stroking/Metronome/50 bpm.mp3");
        sleep(25 + 5 * getVar("ExerciseLevel"));
        stopAudio();
...
function Abs4() {
    if (!exabs4) {
        ...
        sendVirtualAssistantMessage(" Continue until you hear my bell", 1, true);
        playAudio("Audio/GNMSounds/Stroking/Metronome/60 bpm.mp3");
        sleep(25 + 5 * getVar("ExerciseLevel"));
        stopAudio();
        ...
        sleep(20);
        sendVirtualAssistantMessage(" Continue until you hear my bell", 1, true);
        playAudio("Audio/GNMSounds/Stroking/Metronome/70 bpm.mp3");
        sleep(25 + 5 * getVar("ExerciseLevel"));
