{
    let answers = [
        ...
        'Are your %Balls% starting to turn blue yet? %Giggles%',
        ...
        'I hope showing you some pictures now and then is enough to keep your arousal levels up %Smile% @ShowBlogImage',
        ...
        'This is almost as sexy as some of the stuff I say %Grin% @ShowCaptionImage',
        'I\'ll have to remember some of these lines to use against you later %Grin% @ShowCaptionImage',
        'Well, at least now I know how you liked to be talked to %Grin% @ShowCaptionImage',
        'So this is the kind of stuff that turns you on huh? I\'ll remember that %Grin% @ShowCaptionImage',
        'So this is the kind of girl you really want me to be huh? %Grin% @ShowCaptionImage',
    ...
    if(hasChastityCage()) {
        answers.push(
            ...
            'If your %Cock% wasn\'t locked away right now, maybe you could rub it on this ass @ShowButtImage',
            ...
            'You must feel so powerless right now, with your %Cock% locked up',
            ...
            'Does this make your %Balls% ache? %Grin% @ShowBoobsImage',
            'I wonder how long it takes for your %Cock% to forget how to get hard...',
        ...
        answer.push('I hope you %Cock% isn\'t getting limp',
            ...
            'Imagine how hard those lips would make your %Cock% right now @ShowBlowjobImage',
