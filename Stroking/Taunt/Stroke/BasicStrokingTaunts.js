{
    let answers = [
        ...
        'Make that %Cock% hard as a rock for me',
        'Make that %Cock% harder than it\'s ever been',
        ...
        'I love making you ' + random('do this', 'stroke', 'jerk off') + ' for me',
        ...
        'Mmmm stroke that %Cock% for me %SlaveName%',
        ...
        'I\'m gonna make sure that %Cock% remembers every single stroke you give to me %Grin%',
        ...
        'You need to keep stroking that %Cock%',
        'Keep stroking my toy, %SlaveName%',
        'Don \'t stop stroking that %Cock%',
