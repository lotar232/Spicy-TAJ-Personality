...
function putClampsOnOneSide(amount, bodyPart) {
    sendMessage(getClampsOnSentenceStart() + " " + amount + pluralize(" clothespin", amount) + " and " + random("put " + pluralizeArticle("it", amount) + " on", "attach " + pluralizeArticle("it", amount) + " to") + " your " + bodyPart.sidedName);
